...
const initialMessages: Message[] = [
  { 
    ...
    author: "Rajesh Kumar", 
    unit: "B-304", 
    content: "Hi everyone, AGM is next week. Please mark your calendars.", 
  ...
  { 
    ...
    author: "Priya Sharma", 
    unit: "A-201", 
    content: "Can someone share the minutes from the last meeting?", 
  ...
  { 
    ...
    unit: undefined, 
    content: "Minutes have been uploaded under Documents.", 
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 4.25).toISOString() 
  },
];
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Communicate with your neighbors and society members
          </p>
        </div>
          ...
          <div className="border-t p-4">
            <div className="flex items-end gap-2">
              <Textarea
                ...
                rows={1}
              />
              <Button variant="outline" size="icon" type="button" title="Attach (mock)">
